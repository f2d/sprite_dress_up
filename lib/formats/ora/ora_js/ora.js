...
//* Add image files and paths, batched by prefix and sorted by index:
		...
		function addOtherDataFilesToArchive() {
			...
			function getOnExtractBlobFunction(dataFile, filePath) {
			...
			var	dataFile = includeOtherFilesByPath[filePath];
				dataFile.getBlob('application/octet-stream', getOnExtractBlobFunction(dataFile, filePath));
			}
		}
...
//* Note: dataURI has lower length limits than blobs.
	...
	function extractImage(path, zipFile, onImageLoad, onDone, onError) {
