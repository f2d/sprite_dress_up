...
//* Return references to public functions, callable from outside: -------------
	...
	return {
		linear_burn	: linear_burn	,	//* <- OK with opaque bottom or clipping group
		linear_light	: linear_light	,	//* <- OK with opaque bottom or clipping group
		...
		opaque		: opaque	,	//* <- may be slower than normal JS one-liner
	};
}
